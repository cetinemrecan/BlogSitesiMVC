...
{
    public partial class initDbBlog : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloggerAbout = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BloggerImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BloggerMail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BloggerPassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BloggerStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
